...
# here unchanged, so the SDK is copied as it is from where the ABI lives --
# github.com/jesusluque/aopenfx, sdk/include/aofx -- and follows its bumps,
# never this engine's needs. This test fails on any change to a header -- an
# edit, a new header, a removed one -- so a change is always a decision:
# re-record with -DRECORD=ON only when aopenfx's SDK moved the same way.
#
...
if(NOT recorded STREQUAL lines)
    message(FATAL_ERROR "the aofx SDK headers differ from ${MANIFEST}.\n"
                        ...
                        "aopenfx's SDK (github.com/jesusluque/aopenfx) changed identically.")
endif()
